...
<?php 
    if(isset($_GET["search"])) {
        ...
        $search = $_GET["search"];
        $sql = "SELECT * FROM departments WHERE department_name LIKE '%$search%';";
...
<table class="users-data">
    ...
    <tbody>
        <tr>
            ...
            <td><a href="teachers.result.php?teachers_id=<?= $row["department_id"]; ?>"><?php echo $row["department_head"]; ?></td>
        </tr>
    </tbody>
    <?php } ?>
</table>