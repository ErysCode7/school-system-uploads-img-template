...
<?php 
    if(isset($_GET["search"])) {
        ...
        $search = $_GET["search"];
        $sql = "SELECT * FROM students WHERE first_name LIKE '%$search%' ||
        last_name LIKE '%$search%' || email LIKE '%$search%';";
...
<table class="users-data">
    ...
    <tbody>
        <tr>
            <td><a href="ViewDetails.php?ID=<?= $row["student_id"]; ?>">View Details</a></td>
